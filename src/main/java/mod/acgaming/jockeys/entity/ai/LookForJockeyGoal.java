package mod.acgaming.jockeys.entity.ai;
...
public class LookForJockeyGoal extends Goal
{
    ...
    public LookForJockeyGoal(Mob entity, double speed, float distance, float area)
    {
        this.mob = entity;
        this.followPredicate = (p_25278_) -> p_25278_ != null && entity.getClass() != p_25278_.getClass();
